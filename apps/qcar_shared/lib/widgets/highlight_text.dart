...
class HighlightText extends StatelessWidget {
  ...
  /// The sub-string that is highlighted inside {HighlightText.text}.  (Either term or terms must be passed.  If both are passed they are combined.)
  final String? term;

  /// The array of sub-strings that are highlighted inside {HighlightText.text}.  (Either term or terms must be passed.  If both are passed they are combined.)
  final List<String>? terms;

  /// The String searched by {HighlightText.term} and/or {HighlightText.terms} array.
  final String text;

  /// How the text should be aligned horizontally.
  final TextAlign textAlign;

  /// The {TextStyle} of the {HighlightText.text} that isn't highlighted.
  final TextStyle? textStyle;

  /// The {TextStyle} of the {HighlightText.term}/{HighlightText.ters} matched.

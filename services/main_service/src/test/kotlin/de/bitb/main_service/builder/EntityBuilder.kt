...
private fun loadTestCustomerFile(jsonFile: String): String = loadJsonFile("$BASE_TESTDATA_PATH/customer/$jsonFile")
private fun loadTestDealerFile(jsonFile: String): String = loadJsonFile("$BASE_TESTDATA_PATH/dealer/$jsonFile")
